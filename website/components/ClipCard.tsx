...
export function ClipCard({
  ...
  return (
    <div
      className={`relative w-[210px] shrink-0 snap-start overflow-hidden rounded-2xl border ${ring} bg-forest-900 shadow-card`}
    >
      <Clip src={src} className="aspect-[9/16] w-full object-cover" />
